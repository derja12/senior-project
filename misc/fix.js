const fix = async () => {
    ...
    for (let i in users) {
        ...
        case "derekjacketta@gmail.com":
            ...
            user.listens = user.listens.slice(0, user.listens.length - 200).concat(Object.values(lMap));
        ...
        case "henry@derek.com": 
            ...
            user.listens = user.listens.slice(0, user.listens.length - 150).concat(Object.values(lMap));
            console.log(dupcount)
            console.log("Modified listens", user.listens.length);
            break;
        case "kaleb@mail.com":
            ...
            user.listens = user.listens.slice(0, user.listens.length - 10).concat(Object.values(lMap));
            console.log(dupcount)
            console.log("Modified listens", user.listens.length);
            break;
